        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)', display: 'flex', flexDirection: 'column' }}>
            ...
            <header style={{
                ...
                <Link href="https://cutpulse.com" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
                    ...
                    <span style={{ fontWeight: 900, fontSize: 15, letterSpacing: '-0.02em' }}>
                        <span style={{ color: 'var(--text)' }}>Cut</span>
                        <span style={{ color: '#6366f1' }}>Pulse</span>
                    </span>
                    <span style={{ fontSize: 11, fontWeight: 700, color: '#6366f1', padding: '2px 8px', borderRadius: 999, background: 'rgba(99,102,241,.12)', border: '1px solid rgba(99,102,241,.25)', marginLeft: 4 }}>Affiliates</span>
                </Link>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    {user ? (
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            ...
                            <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text)', maxWidth: 120, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            ...
            <footer style={{ padding: '20px 24px', borderTop: '1px solid var(--border)', textAlign: 'center', fontSize: 12, color: 'var(--text-muted)' }}>
                © 2025 CutPulse · <Link href="https://cutpulse.com" style={{ color: 'var(--indigo)', textDecoration: 'none' }}>Back to App</Link>
            </footer>
        </div>
    )
}
