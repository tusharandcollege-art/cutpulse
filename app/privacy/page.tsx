    ...
    return (
        <div className="min-h-screen p-8 sm:p-20 font-[family-name:var(--font-geist-sans)]" style={{ background: 'var(--bg-main)', color: 'var(--text)' }}>
            <div className="max-w-3xl mx-auto">
                ...
                <h1 className="text-4xl font-black tracking-tight mb-4 text-white">Privacy Policy</h1>
                ...
                <div className="space-y-8 text-sm/relaxed" style={{ color: 'var(--text-2)' }}>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black text-white">3. How We Use Your Information</h2>
                        <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black text-white">4. Data Sharing and Third Parties</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black text-white">5. Cookies and Tracking</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black text-white">6. Data Deletion and Your Rights</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black text-white">7. Young Users</h2>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>For privacy inquiries or to exercise your data rights, please contact us at <strong className="text-white">support@cutpulse.com</strong>.</p>
                    </section>
                </div>
            </div>
        </div>
