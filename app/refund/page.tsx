    ...
    return (
        <div style={{ position: 'fixed', inset: 0, overflowY: 'auto', padding: '32px 80px', background: 'var(--bg)', color: 'var(--text)' }}>
            <div className="max-w-3xl mx-auto">
                ...
                <h1 className="text-4xl font-black tracking-tight mb-4" style={{ color: 'var(--text)' }}>Refund &amp; Return Policy</h1>
                ...
                <div className="space-y-8 text-sm/relaxed" style={{ color: 'var(--text-2)' }}>
                    <section className="space-y-3">
                        <h2 className="text-xl font-black" style={{ color: 'var(--text)' }}>1. Core Policy</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black" style={{ color: 'var(--text)' }}>2. Subscription Cancellations</h2>
                        ...
                        <p className="font-medium" style={{ color: 'var(--text)' }}>We do not provide prorated refunds or partial returns for unused time in a billing cycle.</p>
                    </section>

                    <section className="space-y-3">
                        <h2 className="text-xl font-black" style={{ color: 'var(--text)' }}>3. Accidental Charges and Exceptions</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black" style={{ color: 'var(--text)' }}>4. Artificial Intelligence Generations</h2>
                    ...
                    <section className="space-y-3">
                        <h2 className="text-xl font-black" style={{ color: 'var(--text)' }}>5. How to Request a Refund</h2>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>To request a refund or cancel your subscription, please log into your account settings or contact us at <strong style={{ color: 'var(--text)' }}>support@cutpulse.com</strong>.</p>
                    </section>
                </div>
            </div>
        </div>
